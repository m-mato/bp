...
Java je v súčasnosti jedným z najpužívanejších programovacích jazykov.
...
Hodnotoa položky \textit{attributes\_count} vyjadruje presný počet atribútov
...
je rovná hodnote vyjadrujúcej dĺžku následných informácií, koré sú uložené v 
...
Takisto tento nástroj má niekoľko slabých stránok, niesú však výraznými prekážkami v následnej manipulácií s ním:
