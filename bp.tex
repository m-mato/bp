...
Po nájdení metódy, respektíve metód, ktoré vyplívajú s definícií CLASS, METHOD, prípadne INTERFACE je do každej z nich vložený takzvaný spúšťač \textit{trigger point}.
TODO...

\subsection{Závislosti}

Závislosti pravidiel (\textit{Rule bindings})
TODO...

\subsection{Výrazy}

Výrazy \textit{Rule expressions}
TODO...

\subsection{Podmienky}

Podmienky (\textit{Rule Conditions})
TODO...

\subsection{Akcie}

Akcie pravidiel (\textit{Rule Actions})
TODO...
