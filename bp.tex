...
definoval.~\cite{Oracle:ClassLoader} Žiadna trieda nemôže byť načítaná dva-krát
tým istým \textit{class loaderom}.
...
Pri štandardnom načítaní triedy niektorá z podtreid \textit{ClassLoader} vykoná 
nasledujúce tri kroky:
\begin{enumerate}
...
Získať ho je možné pomocou príkazu \q{\textit{MyClass.class.getClassLoader();}}.
Novú triedu reprezentovanú súborom \textit{class} následne vráti metóda
\textit{class loaderu}: \q{\textit{loadClass(class)}}.

\subsection{Opakované načítanie triedy}
TODO...
